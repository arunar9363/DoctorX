...
function ForgotPassword() {
  ...
  const handleConfirmAndSendEmail = async () => {
    ...
    try {
      ...
      setMessage({
        text: "✓ Password reset email sent! Please check your inbox and spam folder. Click the link in the email to proceed.",
        type: "success"
      });
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      ...
      if (err.code === "auth/expired-action-code") {
        errorMessage = "✗ Reset code has expired. Please request a new reset email.";
